...
ERC6551Registry.prototype.generateAccountBytecode = function(salt, chainId, tokenContract, tokenId, implementationAddress) {
...
ERC6551Registry.prototype.getAccountAddress = function(salt, chainId, tokenContract, tokenId, implementationAddress) {
    const bytecode = this.generateAccountBytecode(salt, chainId, tokenContract, tokenId, implementationAddress);
